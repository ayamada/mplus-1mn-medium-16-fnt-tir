<div align="center"><img src="https://github.com/ayamada/mplus-1mn-medium-16-fnt-tir/raw/master/img/ss_00.png" /></div>
...
- ライセンスがゆるくて、見た目がよく、汎用的に利用できるフォントの探索

- 文字種優先順位を決定する為のテキストデータソースの探索
